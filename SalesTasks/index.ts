  ...
  implements ComponentFramework.ReactControl<IInputs, IOutputs>
{
  ...
  public init(
    ...
    this.vm = new SalesTasksVM(this.serviceProvider, EntityId);
    this.serviceProvider.register<SalesTasksVM>(
      SalesTasksVM.serviceName,
      this.vm
    );
  }
  ...
  public updateView(
    ...
    const EntityId = context.mode.contextInfo.entityId as string;
    ReactDOM.render(
      createElement(App, {
